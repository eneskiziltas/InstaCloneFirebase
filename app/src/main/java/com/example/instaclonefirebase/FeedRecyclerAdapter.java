...
public class FeedRecyclerAdapter extends RecyclerView.Adapter<FeedRecyclerAdapter.PostHolder> {
    ...
    public FeedRecyclerAdapter(ArrayList<String> userEmailList, ArrayList<String> userCommentList, ArrayList<String> getUserImageList) {
        this.userEmailList = userEmailList;
        this.userCommentList = userCommentList;
        this.userImageList = getUserImageList;
    }
    ...
    class PostHolder extends RecyclerView.ViewHolder{
        ...
        public PostHolder(@NonNull View itemView) {
            ...
            commentText = itemView.findViewById(R.id.recycleview_row_comment_text);
